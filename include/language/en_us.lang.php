 ...
 * SugarCRM" logo and "Supercharged by " logo. If the display of the logos is not
 * reasonably feasible for technical reasons, the Appropriate Legal Notices must
 * display the words "Powered by SugarCRM" and "Supercharged by ".
 */
...
$app_strings = array(
    ...
    'LBL_EMAIL_ARCHIVE_TO_SUITE' => 'Import to ',
    ...
    'LBL_EMAIL_IMPORT_EMAIL' => 'Import into ',
    ...
    'LBL_EMAIL_MENU_HELP_ADD_FOLDER' => 'Create a Folder (remote or in )',
    'LBL_EMAIL_MENU_HELP_DELETE_FOLDER' => 'Delete a Folder (remote or in )',
    ...
    'LBL_EMAIL_MENU_HELP_RENAME_FOLDER' => 'Rename a Folder (remote or in )',
    ...
    'LBL_EMAIL_SPACER_LOCAL_FOLDER' => '[ Folders ]',
    'LBL_EMAIL_SUBJECT' => 'Subject',
    'LBL_EMAIL_SUCCESS' => 'Success',
    'LBL_EMAIL_SUITE_FOLDER' => 'Folder',
    ...
    'ERR_NO_DB' => 'Could not connect to the database. Please refer to .log for details (0).',
    'ERR_DB_FAIL' => 'Database failure. Please refer to .log for details.',
    'ERR_DB_VERSION' => '{0} Files May Only Be Used With A {1} Database.',
    ...
    'LBL_BROWSER_TITLE' => '- Open Source CRM',
    'LBL_BUGS' => 'Bugs',
    'LBL_BY' => 'by',
    'LBL_CALLS' => 'Calls',
    ...
    'LBL_EMPTY_REQUIRED_VCARD' => 'vCard does not have all the required fields for this module. Please refer to .log for details.',
    'LBL_VCARD_ERROR_FILESIZE' => 'The uploaded file exceeds the 30000 bytes size limit which was specified in the HTML form.',
    'LBL_VCARD_ERROR_DEFAULT' => 'There was an error uploading the vCard file. Please refer to .log for details.',
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'ERR_SUHOSIN' => 'Upload stream is blocked by Suhosin, please add &quot;upload&quot; to suhosin.executor.include.whitelist (See .log for more information)',
    ...
    'LBL_SUITE_SUPERCHARGED' => 'Supercharged by ',
    'LBL_SUITE_POWERED_BY' => 'Powered By SugarCRM',
    'LBL_SUITE_DESC1' => 'has been written and assembled by <a href="https://salesagility.com">SalesAgility</a>. The Program is provided AS IS, without warranty. Licensed under AGPLv3.',
    ...
    'LBL_SUITE_DESC3' => 'is a trademark of SalesAgility Ltd. All other company and product names may be trademarks of the respective companies with which they are associated.',
...
$app_strings['LBL_GOOGLE_SYNC_ERR'] = 'Google Sync - ERROR';
