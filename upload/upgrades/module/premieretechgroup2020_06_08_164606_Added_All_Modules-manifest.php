...
$manifest = array (
  ...
  'description' => 'premieretechgroup  - Added all modules that needed',
  'icon' => '',
  'is_uninstallable' => true,
  'name' => 'premieretechgroup',
  'published_date' => '2020-06-08 14:45:43',
  'type' => 'module',
  'version' => 1591627544,
...
$installdefs = array (
  ...
  array (
    ...
    array (
      ...
      'class' => 'ptg_HostedAntiSoftwareEmail',
      'path' => 'modules/ptg_HostedAntiSoftwareEmail/ptg_HostedAntiSoftwareEmail.php',
      'tab' => true,
    ),
    10 => 
    array (
    ...
    array (
      'module' => 'ptg_Message',
      'class' => 'ptg_Message',
      'path' => 'modules/ptg_Message/ptg_Message.php',
      'tab' => true,
    ),
    17 => 
    array (
    ...
    array (
      ...
      'class' => 'ptg_MicrosoftOfficeDesktop',
      'path' => 'modules/ptg_MicrosoftOfficeDesktop/ptg_MicrosoftOfficeDesktop.php',
      'tab' => true,
    ),
    19 => 
    array (
    ...
    array (
      ...
      'class' => 'ptg_OtherLicensedSoftwareDesktop',
      'path' => 'modules/ptg_OtherLicensedSoftwareDesktop/ptg_OtherLicensedSoftwareDesktop.php',
      'tab' => true,
    ),
    24 => 
    array (
    ...
    array (
      ...
      'class' => 'ptg_QuickBooksDesktop',
      'path' => 'modules/ptg_QuickBooksDesktop/ptg_QuickBooksDesktop.php',
      'tab' => true,
    ),
    29 => 
    array (
    ...
    array (
      ...
      'class' => 'ptg_SharepointOnPremise',
      'path' => 'modules/ptg_SharepointOnPremise/ptg_SharepointOnPremise.php',
      'tab' => true,
    ),
    35 => 
    array (
  ...
  array (
    ...
    9 => 
    array (
      'from' => '<basepath>/SugarModules/modules/ptg_HostedAntiSoftwareEmail',
      'to' => 'modules/ptg_HostedAntiSoftwareEmail',
    ),
    10 => 
    array (
    ...
    16 => 
    array (
      'from' => '<basepath>/SugarModules/modules/ptg_Message',
      'to' => 'modules/ptg_Message',
    ),
    17 => 
    array (
    ...
    18 => 
    array (
      'from' => '<basepath>/SugarModules/modules/ptg_MicrosoftOfficeDesktop',
      'to' => 'modules/ptg_MicrosoftOfficeDesktop',
    ),
    19 => 
    array (
    ...
    23 => 
    array (
      'from' => '<basepath>/SugarModules/modules/ptg_OtherLicensedSoftwareDesktop',
      'to' => 'modules/ptg_OtherLicensedSoftwareDesktop',
    ),
    24 => 
    array (
    ...
    28 => 
    array (
      'from' => '<basepath>/SugarModules/modules/ptg_QuickBooksDesktop',
      'to' => 'modules/ptg_QuickBooksDesktop',
    ),
    29 => 
    array (
    ...
    34 => 
    array (
      'from' => '<basepath>/SugarModules/modules/ptg_SharepointOnPremise',
      'to' => 'modules/ptg_SharepointOnPremise',
    ),
    35 => 
    array (
