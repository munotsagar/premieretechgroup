...
//require_once('modules/qr_QR_Boxes/qr_QR_BoxesListViewSmarty.php');
    class ptg_VendorCommissionViewList extends ViewList{
    ...
    public function listViewProcess() {
        ...
        if($current_user->user_category_c == "Vendor") {
            ...
            if($num > 0) {
                ...
                $this->params['custom_where'] = ' AND ptg_vendorcommission_cstm.user_id_c IN ('.implode(", ", $userIds).') ';

            } else {
                $this->params['custom_where'] = ' AND ptg_vendorcommission_cstm.user_id_c = "'.$current_user->id.'" ';
            }
        }
