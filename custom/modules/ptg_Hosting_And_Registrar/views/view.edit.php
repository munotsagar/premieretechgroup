...
class ptg_Hosting_And_RegistrarViewEdit extends ViewEdit
{	
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        $("input[title='Save']").click(function(){
        	if($("#registrar_password_c").val() != "" || $("#confirm_password_c").val() != ""){
        		if($("#registrar_password_c").val() != $("#confirm_password_c").val()) { 
                    alert("Registrar Password & Confirm Password doesn't match!");
                    return false;
            	}
        	}
