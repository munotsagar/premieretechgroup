...
class ptg_LocalAreaNetworkInformationViewEdit extends ViewEdit
{	
    ...
    {
        global $bean; 
		$pass = $bean->password_c;
        $confirm_pass = $bean->confirm_password_c;
        // echo "Hii";
        // exit();
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        $("input[title='Save']").click(function(){
        	if($("#domain_server_password_c").val() != "" || $("#confirm_password_c").val() != ""){
        		if($("#domain_server_password_c").val() != $("#confirm_password_c").val()) { 
                    alert("Domain Server Password & Confirm Password doesn't match!");
                    return false;
            	}
        	}
