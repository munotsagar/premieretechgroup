...
EOD
    ...
    $(document).ready(function(){
        $("#network_profile_label_c").parent().prev().removeClass();
        $("#network_profile_label_c").parent().hide();
    });
</script>
        <?php
...
/*Code by Sachin for hiding the organization field from vendor when he create new user.*/
