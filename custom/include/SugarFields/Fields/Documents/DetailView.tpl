...
<br><br><a href="javascript:void(0)" onclick="document.getElementById('{{$vardef.name}}_light').style.display='block';document.getElementById('{{$vardef.name}}_fade').style.display='block'">
 ...
 {/foreach}
  ...
  <div id="{{$vardef.name}}_light" class="white_content" style="display: none;"><!-- You can move inline styles to css file or css block. -->
    <div id="{{$vardef.name}}_slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px; height: 556px;">
        ...
        {foreach from=$images item=item}
            ...
            {assign var="url" value={{$image_path}}$item}
            {if file_exists($url)}
        ...
        {literal}
        <script>
            jssor_slider1_starter('{{$vardef.name}}_slider1_container');
        </script>
        {/literal}
    </div>
    <!-- Jssor Slider End -->
...
<div id="{{$vardef.name}}_fade" class="black_overlay" style="display: none;" onclick="document.getElementById('{{$vardef.name}}_light').style.display='none';document.getElementById('{{$vardef.name}}_fade').style.display='none'"></div>
    ...
    $(document).keyup(function(e) {
     if (e.keyCode == 27) { 
        ...
        document.getElementById('{{$vardef.name}}_light').style.display='none';
        document.getElementById('{{$vardef.name}}_fade').style.display='none';
    }
});
</script>
    {/literal}